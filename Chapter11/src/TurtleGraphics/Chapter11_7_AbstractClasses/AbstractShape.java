...
// AbstractShape.java: The abstract class for all shapes
import TurtleGraphics.Pen;
// Notice the use of the word "abstract" in the class header.
// This class implements the Shape interface.
// We don't need to say that the class extends Object as that is the
// default.
...
// to initialize its variables.
    ...
    // There is no code for the next two methods; therefore,
// they are abstract and terminate with a semicolon.
// All subclasses must define these methods.
    abstract public double area();
    abstract public void draw(Pen p);
    // These next three methods will never be changed in a subclass;
// therefore, they are declared final, meaning they
